...
window.addEventListener("DOMContentLoaded", (event) => {
 ...
 const createInnerHtml = () => {
    ...
    <td>
     ...
     <td>
     <img name="${employee._id}" onclick="remove(this)" alt="delete" src="../assets/images/delete.jpg" width="30px"">
     <img name="${employee._id}" alt="edit" onclick="update(this)" src="../assets/images/edit.jpg" width="30px">   
     </td>
    </tr>
    `;
    }
